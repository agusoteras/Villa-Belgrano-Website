  ...
  <div className="carousel-inner">
    ...
    <div className="carousel-item">
      ...
      <div className="carousel-caption d-none d-md-block">
        ...
        <p>Te invitamos a disfrutar de nuestra feria los segundos Sábados de cada mes en la plaza Manuel Belgrano</p>
      </div>
    </div>
  </div>
